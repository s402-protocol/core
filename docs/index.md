...
**v0.1.8** · Exact, Prepaid, and Escrow schemes are stable · 643 tests (226 Move + 417 TypeScript) with property-based fuzzing · Apache-2.0 · [View on npm](https://www.npmjs.com/package/s402)
