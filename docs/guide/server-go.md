...
s402 ships [161 machine-readable JSON test vectors](/guide/conformance) in `spec/vectors/`. Use them to verify your Go implementation matches the spec — no TypeScript required:
